            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">DAFTAR KUNJUNGAN RUKES</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container mt-5">
            <div class="row pt-5">
                <div class="col-md-7">
                    ...
                    <button class="btn btn-danger rounded-pill">DAFTAR SEKARANG</button>
                </div>
                <div class="col-md-5">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-7 order-md-2">
                    <h2 class="featurette-heading">Kegiatan <span class="text-muted"></span></h2>
                    <p class="lead">
                    Foto Saat Pelatihan Dasar 120 Jam Di Lapangan
                    </p>
                </div>
                <div class="col-md-5 order-md-1">
                <img src="assets/img/latdas.jpg" width="450" height="300" alt="">
                </div>
            </div>
            <hr class="featurette-divider">
            <div class="row featurette">
                <div class="col-md-7">
                    <h2 class="featurette-heading">Kegiatan <span class="text-muted"></span></h2>
                    <p class="lead">
                    Foto Saat Latihan Gabungan Perti Se Kalimantan Selatan
                    </p>
                </div>
                <div class="col-md-5">
                <img src="assets/img/latgab.png" width="600" height="300" alt="">
                </div>
            </div>
            <hr class="featurette-divider">
            <!-- /END THE FEATURETTES -->
