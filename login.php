...
<head>
  ...
  <meta name="description" content="Aplikasi pendaftaran Anggota Baru UKM KSR PMI STMIK INDONESIA BANJARMASIN.">
  <meta name="author" content="e-development.tech">

  <title>Login Aplikasi Pendaftaran Anggota Baru</title>
              ...
              <div class="col-md-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="assets/img/PMI.png" alt="Logo ukm" class="logo-login">

                    <h1 class="h4 text-gray-900">Aplikasi Pendaftaran Anggota Baru</h1>
                    <h1 class="h4 text-gray-900 mb-4"><b>KSR PMI STMIK INDONESIA BANJARMASIN</b></h1>
