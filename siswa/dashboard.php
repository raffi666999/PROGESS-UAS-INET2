    ...
    <div class="col-md-6">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">JAWABLAH PERTANYAAN DIBAWAH INI !</h6>
              </div>
              <div class="card-body">
                  <p class="text-danger">* Tuliskan jawaban anda untuk menyelesaikan proses pendaftaran !</p>
                  <form class="user" method="POST" action="<?= $base_url ?>/siswa/dashboard.php">
                      <div class="form-group">
                          <label for="un">Mengapa anda ingin masuk KSR PMI ?</label>
                          <input type="varchar" class="form-control" id="un" placeholder="Tuliskan Jawaban Anda" name="un">
                      </div>
                      <div class="form-group">
                          <label for="un">Tuliskan pengalaman anda ketika sedang melakukan pertolongan pertama pada luka seseorang ?</label>
                          <input type="varchar" class="form-control" id="un" placeholder="Tuliskan Jawaban Anda" name="us">
                      </div>
                      <div class="form-group">
                          <label for="uts_1">Apa yang ingin anda lakukan ketika sudah menjadi anggota KSR PMI STMIK IB ?</label>
                          <input type="varchar" class="form-control" id="uts_1" placeholder="Tuliskan Jawaban Anda" name="uts_1">
                      </div>
                      <hr>
              ...
              <div class="card-body">
                <div class="card text-center">
                  ...
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">KSR PMI STMIK INDONESIA BANJARMASIN</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi menjadi anggota KSR PMI STMIK INDONESIA BANJARMASIN </p>
                    <span class="badge badge-danger" style="font-size: 20px;"></span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">KSR PMI STMIK INDONESIA BANJARMASIN</marquee>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">PERSYARATAN DAFTAR</h6>
            </div>
            <div class="card-body">
              <p> </p>
              ...
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  1. MAHASISWA AKTIF STMIK INDONESIA BANJARMASIN
                  <span class="badge badge-info badge-pill"></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  2. MAKSIMAL SEMESTER 3 ( SEMUA JURUSAN )
                  <span class="badge badge-info badge-pill"></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  3. BERSEDIA MENGIKUTI PENDIDIKAN LATIHAN DASAR DAN PELATIHAN DASAR
                  <span class="badge badge-info badge-pill"></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
